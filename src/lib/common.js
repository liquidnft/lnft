...
function encode$1 (r, s) {
  ...
  var signature = Buffer$f.allocUnsafe(6 + lenR + lenS);
...
function encode$3 (number, buffer, offset) {
  checkUInt53(number);

  if (!buffer) buffer = Buffer$g.allocUnsafe(encodingLength(number));
  if (!Buffer$g.isBuffer(buffer)) throw new TypeError('buffer must be a Buffer instance')
  if (!offset) offset = 0;
...
var varuintBitcoin = { encode: encode$3, decode: decode$3, encodingLength: encodingLength };
...
export { Buffer as B, browser$2 as a, browser$1 as b, createCommonjsModule as c, bn as d, hmacDrbg as e, brorand as f, bs58check as g, hash_1 as h, inherits_browser as i, bip66 as j, bech32 as k, browser$3 as l, minimalisticAssert as m, fastRoot as n, getDefaultExportFromCjs as o, typeforce_1 as t, utils_1 as u, varuintBitcoin as v, wif as w };
