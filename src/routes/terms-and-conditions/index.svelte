...
<div class="max-w-4xl container mx-auto sm:justify-between mt-10 md:mt-20">
  <div class="mx-auto">
    <h2 class="mb-10">Maven Terms and Conditions</h2>
    <div class="faq-content">
      <div class="faq">
        <p>
          Maven is a bitcoin-focused digital art website based on the LNFT
          platform which provides a new way for artists and their fans to
          interact in a more direct way. Maven provides artists with an easy
          and intuitive way to mint and trade non-fungible tokens (NFTs) on the
          Liquid Network (a Bitcoin sidechain). Maven allows fans to support
          their favourite artist through digital patronage. As an artist or fan
          you should understand exactly how Maven works before you decide to
          participate. These Terms &amp; Conditions give a quick summary, but
          you should review the Maven FAQs and ask questions on the
          Maven support forums to get more information.
        </p>
        ...
        <p>
          Maven is an open source curated instance of the LNFT platform for
        ...
        <p>
          ...
          <a href="mailto:support@mavennft.io">support@mavennft.io</a>
        </p>
        ...
        <p>
          Maven is a non-custodial service meaning that neither the Website
          ...
          acknowledge and agree that the technologies used in Maven
          ...
          the Maven services may be subject to bugs, malfunctions, timing
          ...
          Maven Items, or lost opportunities to buy or sell Maven Items.
          Maven and Operator assume no liability or responsibility for any
        ...
        <p>
          Transactions in Maven are peer-to-peer and use atomic swaps. This
          ...
          corresponding royalties. Initially Maven will not charge any fee
          for any transaction performed in the Website (other than Liquid
          transaction fees), but this may change in the future.
        </p>

        <h3>Creation of Maven Items</h3>

        <p>
          All Artwork (“Artwork(s)”, “Creation(s)”, “Work”) posted on the
          Maven website is associated with a unique Liquid asset exclusively
          issued by an approved Maven Artist. Each Maven Item
          ...
          be used by Artists in Maven to post their Work are jpg, png, gif
          and mp4. When an Artist first uploads his or her Work to Maven,
          ...
          provides Maven Artists and Fans with a permanent record of
          ...
          primary sale. After a Maven Item is sold by the original Artist,
        ...
        <p>
          ...
          Website, mint Tokens and make a primary Sale of Maven Items. This
          responsibility will then be passed on to the active Maven Artists.
          Artists seeking an invitation to create and list works for sale on
          Maven must submit a request that can be found here. Please keep in
          mind that due to current limited resources this process could
          initially extend for months. Maven has unilateral discretion in
        ...
        <ul>
          ...
          <li>
            Artist agrees to indemnify Maven and Operator and be held liable
            for any claim against Maven or Operator arising out of the
            Artist’s breach of these Terms. Artist releases and forever
            discharges Maven and Operator from any damages or causes of
            action resulting from a sale of any of the Artist’s listed Maven
        ...
        <p>
          ...
          warranties to Operator and the Artist or any other Maven User
          that:
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            Artwork will be explicitly described in the Maven Item Sale.
        ...
        <h3>Maven Marketplace</h3>

        <p>
          Maven provides an easy and intuitive way for Artists and Fans to
          buy and sell Maven Items. Artworks are listed in a
          ...
          or Maven Items. Listings, bids, transfers and new Artwork activity
        ...
        <ul>
          <li>
            ...
            for the Maven Item or not, and decide on the listing asset
            ...
            originally listing a Maven Item in a primary sale. This rate can
            not be modified afterwards by any Token owner. This listing option
            keeps the Maven Item available for purchase/bid as long as the
        ...
        <ul>
          <li>
            ...
            the Maven Item. This allows Users to make offers on a Maven
            Item that the Artist or current owner of the Maven Item can then
            accept, reject or wait until more offers are available.
          </li>
          <li>
            Buy Now: Artist or Token owners can decide to list a Maven Item
            for a predefined price. This allows other Users to automatically buy
            the Maven Item for the listed price. The completion of the trade
            is enforced by an atomic swap transaction created by the Artist or
            Token owner wallet when listing a Maven Item. In this scenario
            however, it is also possible for Users to make an offer instead of
            buying the Maven Item.
          </li>
        </ul>
