            ...
            <label>Price
              <span class="tooltip">
                ...
                <span class="tooltip-text bg-gray-100 shadow ml-4 rounded">
                  Setting a listing price is optional. If you set one, a
                  pre-signed swap transaction will be generated by your wallet,
                  giving potential collectors the ability to immediately
                  purchase the artwork. So think of this as the "Buy it now"
                  price.
                  <br /><br />
                  Changing the price once it's been set involves sending an
                  on-chain cancellation transaction and will incur a network
                  transaction fee.
                </span>
              </span></label>
            <input
